      ...
      {fights.map(fight => (
        <tr key={fight.event}>
          ...
          <td className={styles.fightersColumn}>
            {fighterName}
            <br />
            <p className={styles.textGrayed}>{fight.opponent}</p>
          </td>
          <Hidden mdDown>
            ...
            <td className={styles.statisticsColumn}>
              {fight.fighterStatistics.str}
              <br />
              <p className={styles.textGrayed}>
                {fight.opponentStatistics.str}
              </p>
            </td>
            <td className={styles.statisticsColumn}>
              {fight.fighterStatistics.td}
              <br />
              <p className={styles.textGrayed}>{fight.opponentStatistics.td}</p>
            </td>
            <td className={styles.statisticsColumn}>
              {fight.fighterStatistics.sub}
              <br />
              <p className={styles.textGrayed}>
                {fight.opponentStatistics.sub}
              </p>
            </td>
            <td className={styles.statisticsColumn}>
              {fight.fighterStatistics.pass}
              <br />
              <p className={styles.textGrayed}>
                {fight.opponentStatistics.pass}
              </p>
            </td>
            ...
            <td>
              <p className={styles.textNormal}>{fight.awards}</p>
            </td>
          </Hidden>
        </tr>
      ))}
